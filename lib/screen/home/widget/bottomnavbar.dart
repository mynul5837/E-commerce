    ...
    return BottomNavigationBar(
      ...
      items: [
        BottomNavigationBarItem(
          icon: Icon(Iconsax.home_outline, size: 20),
          label: "HOME",
        ),
        BottomNavigationBarItem(
          icon: Icon(Iconsax.heart_outline, size: 20),
          label: "WISHLIST",
        ),
        BottomNavigationBarItem(
          icon: Icon(Iconsax.shopping_bag_outline, size: 20),
          label: "ORDER",
        ),
        BottomNavigationBarItem(
          icon: Icon(FontAwesome.user, size: 20),
          label: "LOGIN",
        ),
      ],
    );
